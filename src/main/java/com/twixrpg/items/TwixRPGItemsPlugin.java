...
public final class TwixRPGItemsPlugin extends JavaPlugin {
    ...
    private NamespacedKey cellUuidKey;

    private StorageCellListener storageCellListener;
    ...
    public void onEnable() {
        ...
        cellUuidKey = new NamespacedKey(this, "cell_uuid");
    ...
    public void onDisable() {
        if (storageCellListener != null) {
            storageCellListener.saveAllOpen();
        }
    ...
    public NamespacedKey getCellUuidKey() {
        return cellUuidKey;
    }
